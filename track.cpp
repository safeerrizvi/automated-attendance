...
{ //int a=0;
    ...
    while (1)
    {
        ...
        if (i == 0)
            ...
            num = 'A';
        if (longitude == 2 && latitude == 2 && tm.tm_hour == 8 && tm.tm_min >= 00 && tm.tm_min <= 15)
        { //sleep(5);
            {
                num = 'P';
                //// // //;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 12 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // // //  //13;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 13 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // //  //1;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 15 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // //  //2;
            ...
            if (i == 0)
                ...
                //the program checks for time first then runs taking coordinates every 10 minutes
                num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 9 && tm.tm_min >= 00 && tm.tm_min <= 00)
            { //sleep(5);
                {
                    num = 'P';
                    //// // //23;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 10 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // // ///4;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 2 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // // ///20;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 11 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // // //14;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 15 && tm.tm_min >= 00 && tm.tm_min <= 40)
            { //);
                {
                    num = 'P';
                    // // //16;
            ...
            //the program checks for time first then runs taking coordinates every 10 minutes
            num = 'A';
            if (longitude == 2 && latitude == 2 && tm.tm_hour == 14 && tm.tm_min >= 00 && tm.tm_min <= 15)
            { //);
                {
                    num = 'P';
                    // // //19;
